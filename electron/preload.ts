...
contextBridge.exposeInMainWorld("desktopApi", {
  ...
  listMikhmonSales: (): Promise<MikhmonSale[]> => ipcRenderer.invoke("cybercafe:mikhmon:list"),
  importMikhmonCsv: (fileName: string, content: string): Promise<MikhmonImportSummary> => ipcRenderer.invoke("cybercafe:mikhmon:import", fileName, content),
